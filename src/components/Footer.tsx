...
const footerLinks = {
  Platform: ['Demo Review', 'Launch Program', 'Playlist Submission', 'Promotion Campaign'],
  Company: ['About Us', 'How It Works', 'FAQ', 'Contact'],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-border/30 pt-16 pb-8 px-6">
      {/* Glow accent */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              Empowering independent and emerging artists worldwide. Your music deserves to be heard.
            </p>
            {/* Social icons */}
