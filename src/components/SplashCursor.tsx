...
// Based on react-bits by David Haz (MIT License)
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function applyInputs() {
      pointers.forEach((p: any) => { if (p.moved) { p.moved = false; splatPointer(p); } });
    }
    ...
    function updatePointerUpData(pointer: any) { pointer.down = false; }
